    ...
    if len(message.command) != 2 :
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('🍁 ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ •', url='https://telegram.me/movi_video7'),
...
async def aboutbot(client, message):
    try:
        ...
        await message.reply(text=f"<b>○ OWNER : <a href='https://t.me/admiinn101'>❤ Zynk Admin 🤞</a>\n○ Developer : <a href='https://t.me/LazyDeveloperr'>❤LazyDeveloperr❤</a></b>", reply_markup=reply_markup, disable_web_page_preview = True, parse_mode=enums.ParseMode.HTML)
